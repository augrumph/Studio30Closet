  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-sm font-medium text-[#4A3B32]",
        ...
        day: cn(
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 inline-flex items-center justify-center rounded-md text-sm ring-offset-white transition-colors hover:bg-gray-100 hover:text-gray-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50"
        ),
        day_range_end: "day-range-end",
        day_selected: "bg-[#C75D3B] text-white hover:bg-[#A64D31] hover:text-white focus:bg-[#C75D3B] focus:text-white",
