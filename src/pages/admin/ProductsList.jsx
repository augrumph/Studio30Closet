    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                // Ensure sales are loaded for analytics
                await loadVendas()
            } catch (err) {
        ...
        fetchProducts()
    }, [loadInventoryForAdmin, loadVendas])
        ...
        <div className="space-y-6 pb-20">
            ...
            >
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="bg-gray-100 p-1 rounded-xl flex items-center">
                        <button
                            ...
                            className={cn(
                                ...
                                !showAnalytics ? "bg-white text-[#4A3B32] shadow-sm" : "text-gray-400 hover:text-gray-600"
                            )}
                        >
                            Lista
                        </button>
                        <button
                            ...
                            className={cn(
                                ...
                                showAnalytics ? "bg-white text-[#C75D3B] shadow-sm" : "text-gray-400 hover:text-gray-600"
                            )}
                        >
                    ...
                    {!showAnalytics && selectedProducts.length > 0 && (
                        <motion.button
